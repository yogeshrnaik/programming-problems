...
STOCK_CATEGORY = {
    ...
    "2-STRONG-NON-CORE": ["BSE", "EUREKAFORBE", "JSWINFRA", "IRCON", "IRFC", "JIOFIN", "MAXHEALTH", "MAXVIL", "POONAWALLA", "TATAELXSI", "SBICARD", "TATACHEM"],
    "3-OTHER-NON-CORE": [
        ...
        "HEMIPROP", "IDEA", "ISMTLTD", "LSIL", "LSIL-BE", "LLOYDSTEEL", "LLOYDSENGG", "LLOYDSENGG-BE", "LLOYDSENT", "MADHAVBAUG-SM", "MADHAVBAUG-ST", "MAFANG", "PVP", "PVP-BE", "PYRAMID", "PYRAMID-BE", "RENUKA",
